...
export const produtoDto = z.object({
    nome: z.string().trim().min(3, "Nome do produto deve ter pelo menos 3 caracteres").max(50, "Nome do produto deve ter no máximo 50 caracteres"),
    ...
    embalagem: z.enum(["SACARIA", "BAG_1TN", "BAG_750KG", "LITRO", "GALAO_2L", "GALAO_5L", "GALAO_10L", "BALDE_20L", "TAMBOR_200L", "IBC_1000L", "OUTROS"]),
